...
parser.add_argument('--log-file', type=str, default='',
                    help='path to save perplexities as a csv log file')
...
def train():
    ...
    return math.exp(epoch_loss / epoch_batches)
...
if args.log_file:
    with open(args.log_file, 'w', encoding='utf-8') as f:
        f.write('epoch,train_ppl,valid_ppl,test_ppl\n')
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if args.log_file:   
            with open(args.log_file, 'a', encoding='utf-8') as f:   
                f.write(f'{epoch},{train_ppl:.4f},{valid_ppl:.4f},\n')
...
if args.log_file:  
    with open(args.log_file, 'a', encoding='utf-8') as f: 
        f.write(f'test,,,{math.exp(test_loss):.4f}\n')  
